...
"%":"ArrayBuffer|Blob|CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|TextMetrics"},
yE:{
"^":"Gv;",
...
v[w]=x
if(w===y.Bq)y.VW();++y.Z1}this.RW=!1}this.CX()},
...
return y},qG:function(a,b,c,d,e){var z
...
dd:[function(a){return H.CU(a)},"$1","zy",2,0,7],
...
return P.xC(0,0,C.CD.yu(C.CD.RE(this.m5*b)),0,0,0)},
...
qE:{
"^":"cv;",
"%":"HTMLAppletElement|HTMLBRElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFontElement|HTMLFrameElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLLegendElement|HTMLMapElement|HTMLMarqueeElement|HTMLMetaElement|HTMLModElement|HTMLParagraphElement|HTMLPictureElement|HTMLPreElement|HTMLQuoteElement|HTMLShadowElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"},
Gh:{
"^":"qE;N:target=,t5:type}",
...
"%":"HTMLBodyElement"},
IF:{
"^":"qE;lz:disabled},t5:type},P:value%",
"%":"HTMLButtonElement"},
Ny:{
...
"%":"HTMLImageElement"},
Mi:{
"^":"qE;d4:checked=,lz:disabled},fg:height%,bO:placeholder},tL:size},t5:type},P:value%,zv:valueAsNumber%,R:width%",
$iscv:true,
$isD0:true,
"%":"HTMLInputElement"},
MX:{
...
"%":"HTMLScriptElement"},
lp:{
"^":"qE;lz:disabled},B:length=,tL:size},P:value%",
...
z=z.ev(z,new W.rp())
return H.VM(new P.Yp(P.F(z,!0,H.W8(z,"mW",0))),[null])}else{z=this.gbG(a)
y=a.selectedIndex
z=z.ON
...
"%":"HTMLStyleElement"},
FB:{
"^":"qE;Si:cols},lz:disabled},P:value%",
$isFB:true,
"%":"HTMLTextAreaElement"},
aG:{
...
z=this.dk.length*2+1
if(z<7)z=7
y=Array(z)
y.fixed$length=init
x=H.VM(y,[H.Kp(this,0)])
y=this.zH
w=this.dk
C.Nm.uy(x,"set range")
H.qG(x,0,y,w,0)
...
z=this.bV.ih
y=this.mu.ih
if(z==null?y==null:z===y)this.Ep=!0
else this.Ep=!1},
bu:function(a){return J.AG(this.bV)}},
eK:{
"^":"a;tL'",
nc:function(){var z,y,x,w
z=this.MJ
if(J.Bl(z,6))this.MY=["#FF0000","#00FF00","#0000FF","#FF00FF","#FFFF00","#00FFFF"]
else{if(typeof z!=="number")return H.s(z)
this.MY=H.VM(Array(z),[P.qU])
for(y=0;y<z;++y){x=this.pE()
for(;w=this.MY,H.Ri(w,x,0,w.length)!==-1;)x=this.pE()
w=this.MY
if(y>=w.length)return H.e(w,y)
w[y]=x}}},
pE:function(){var z,y,x,w
z=this.cN
y=C.CD.BU(z.j1(256)+200,2)
x=z.j1(256)
w=C.CD.BU(z.j1(256)+200,2)
z="#"+C.xB.YX(y.toString(16),2,"0")
z+=C.xB.YX(x.toString(16),2,"0")
return z+C.xB.YX(w.toString(16),2,"0")},
Dd:function(){var z,y,x,w,v,u
z=this.tL
z=J.vX(z,z)
if(typeof z!=="number")return H.s(z)
this.kH=H.VM(Array(z),[D.nX])
y=0
while(!0){z=this.tL
z=J.vX(z,z)
if(typeof z!=="number")return H.s(z)
...
w=C.jn.Y(y,z)
z=this.kH
v=new D.nX(w,x,0,null,this.Yk())
u=[]
u.$builtinTypeInfo=[D.b1]
v.rf=u
if(y>=z.length)return H.e(z,y)
z[y]=v;++y}},
Yk:function(){var z,y,x,w,v
z=this.cN.w7()
for(y=this.LV,x=y.length,w=0;w<x;++w){v=y[w]
...
z.ih=this.Yk()
y=a.mu
y.ih=this.Yk();++z.EY;++y.EY;++this.XI
for(z=z.rf,z=new H.a7(z,z.length,0,null);z.G();){x=z.lo
x.Xg()
if(!x.jR&&x.Ep){w=this.yI
if(w.zH===w.dk.length)w.wL()
w.Et(x,w.zH++)
x.jR=!0}}for(z=y.rf,z=new H.a7(z,z.length,0,null);z.G();){x=z.lo
x.Xg()
if(!x.jR&&x.Ep){y=this.yI
if(y.zH===y.dk.length)y.wL()
y.Et(x,y.zH++)
x.jR=!0}}},
...
y=z.Ux()
y.sjR(!1)
while(!0){if(!(!y.gEp()&&this.yI.zH!==0))break
y=this.yI.Ux()
y.sjR(!1)}if(y.Ep){this.cp(y)
if(this.yI.zH===0)return!0
else return!1}else if(this.yI.zH===0)return!0},
XQ:function(a,b,c,d){var z,y,x,w,v,u
if(this.jk==null){z=this.MJ
if(typeof z!=="number")return H.s(z)
this.jk=1/z}z=this.Nn
if(z==null){z=J.Ts(this.MJ,2)
this.Nn=z}y=this.MJ
if(J.u6(y,z))throw H.b(P.u("Number of colors is less than size of distribution"))
if(typeof y!=="number")return H.s(y)
z=H.VM(Array(y),[P.FK])
this.LV=z
x=this.Nn
...
w=this.jk
v=0
for(;v<x;++v){if(v>=z.length)return H.e(z,v)
z[v]=w}for(v=x;v<y;++v){z=this.LV
x=J.vX(this.Nn,this.jk)
if(typeof x!=="number")return H.s(x)
x=Math.abs(1-x)
w=this.Nn
if(typeof w!=="number")return H.s(w)
...
u=H.ka(z,new D.nx())
if(typeof u!=="number")return H.s(u)
if(Math.abs(1-u)>1e-8)throw H.b(P.u("Your probabilities do not sum to 1: "+H.d(this.LV)))
z=Array(7)
z.fixed$length=init
z=H.VM(z,[null])
this.yI=H.VM(new D.Zg(new D.bv(),z,0),[null])
this.nc()
this.Dd()
this.LS()}},
nx:{
...
bv:{
"^":"Tp:10;",
$2:function(a,b){return a.gx7()-b.gx7()}},
MQ:{
"^":"eK;Fm,i0,od,tL,XI,MJ,MY,cN,jk,Nn,LV,kH,yI",
LS:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=this.Fm===!0
y=this.cN
x=this.i0
w=0
...
o=p+s
n=q.length
if(o>>>0!==o||o>=n)return H.e(q,o)
o=q[o]
u=p+C.jn.Y(r,u)
if(u>>>0!==u||u>=n)return H.e(q,u)
u=q[u]
m=new D.b1(o,u,w,!0,!1)
o.rf.push(m)
u.rf.push(m)
q=o.ih
u=u.ih
if(q==null?u==null:q===u){m.Ep=!0
u=!0}else{m.Ep=!1
u=!1}if(u){u=this.yI
if(u.zH===u.dk.length)u.wL()
u.Et(m,u.zH++)
m.jR=!0}++w}u=this.tL
if(typeof u!=="number")return H.s(u)
if(r<u&&t<u||z){u=y.w7()
...
p=v*q+s
o=u.length
if(p>>>0!==p||p>=o)return H.e(u,p)
p=u[p]
q=C.jn.Y(t,q)*q+C.jn.Y(r,q)
if(q>>>0!==q||q>=o)return H.e(u,q)
q=u[q]
m=new D.b1(p,q,w,!0,!1)
p.rf.push(m)
q.rf.push(m)
u=p.ih
q=q.ih
if(u==null?q==null:u===q){m.Ep=!0
u=!0}else{m.Ep=!1
u=!1}if(u){u=this.yI
if(u.zH===u.dk.length)u.wL()
u.Et(m,u.zH++)
...
p=q[p]
u=C.jn.Y(t,u)*u+s
if(u>>>0!==u||u>=o)return H.e(q,u)
u=q[u]
m=new D.b1(p,u,w,!0,!1)
p.rf.push(m)
u.rf.push(m)
q=p.ih
u=u.ih
...
if(this.Fm===!0)this.od="Torus"
else this.od="Grid"
if(J.xZ(this.i0,0)){z=this.od
if(z==null)return z.g()
this.od=z+" with diagonals"}}},
as:{
"^":"eK;XE,od,tL,XI,MJ,MY,cN,jk,Nn,LV,kH,yI",
Dd:function(){var z,y,x,w,v,u
z=this.tL
if(typeof z!=="number")return H.s(z)
this.kH=H.VM(Array(z),[D.nX])
...
u=w[y];++y
x=C.jn.Y(y,x)
if(x>>>0!==x||x>=v)return H.e(w,x)
x=w[x]
t=new D.b1(u,x,z,!0,!1)
u.rf.push(t)
x.rf.push(t)
w=u.ih
x=x.ih
if(w==null?x==null:w===x){t.Ep=!0
x=!0}else{t.Ep=!1
x=!1}if(x){x=this.yI
if(x.zH===x.dk.length)x.wL()
x.Et(t,x.zH++)
t.jR=!0}++z}for(x=this.kH,x=new H.a7(x,x.length,0,null),w=this.XE,v=this.cN;x.G();){s=x.lo
r=0
while(!0){u=s.grf().length
if(typeof w!=="number")return H.s(w)
if(!(u<w&&r<300))break
u=this.kH
q=v.j1(this.tL)
...
p=u[q]
if(p.rf.length<w&&p!==s&&!C.Nm.tg(s.rf,p)){t=new D.b1(s,p,z,!0,!1)
s.rf.push(t)
p.rf.push(t)
u=s.ih
q=p.ih
if(u==null?q==null:u===q){t.Ep=!0
u=!0}else{t.Ep=!1
u=!1}if(u){u=this.yI
if(u.zH===u.dk.length)u.wL()
u.Et(t,u.zH++)
t.jR=!0}++z}else ++r}if(r>300)H.qw("count too high")}}},
nX:{
"^":"a;x>,y>,EY<,rf<,ih>",
bu:function(a){return H.d(this.x)+" "+H.d(this.y)+" "+H.d(this.ih)}}}],["","",,P,{
"^":"",
...
z="-webkit-"}}}return z}}],["","",,F,{
"^":"",
Iq:[function(){F.Tf(document.querySelector("#controls"))
$.bb=F.S3()},"$0","KW",0,0,2],
Tf:function(a){var z,y,x
J.Ul(a)
F.L0(a)
z=document.querySelector("#graphtype-input")
y=J.RE(z)
x=y.gi9(z)
H.VM(new W.Ov(0,x.uv,x.fA,W.aF(new F.O3(a)),x.el),[H.Kp(x,0)]).DN()
switch(J.Vm(J.n9(y.gpN(z)))){case"grid":F.Z6(a)
break
case"random":y=W.dy("text")
y.id="degree-input"
x=J.RE(y)
x.stL(y,4)
x.sbO(y,"Degree")
a.appendChild(y)
break
default:F.Z6(a)}a.appendChild(document.createElement("br",null))
...
a.appendChild(document.createElement("br",null))
a.appendChild(document.createElement("br",null))
...
J.RE(z).szv(z,20)
y=C.Sw.gi9(z)
H.VM(new W.Ov(0,y.uv,y.fA,W.aF(new F.rs()),y.el),[H.Kp(y,0)]).DN()
a.appendChild(z)
a.appendChild(document.createElement("br",null))
...
z.textContent="Stop"
y=J.Vg(z)
H.VM(new W.Ov(0,y.uv,y.fA,W.aF(new F.Gc()),y.el),[H.Kp(y,0)]).DN()
a.appendChild(z)
z=document.createElement("button",null)
z.id="new-resample"
z.textContent="Restart"
y=J.Vg(z)
H.VM(new W.Ov(0,y.uv,y.fA,W.aF(new F.es()),y.el),[H.Kp(y,0)]).DN()
a.appendChild(z)
a.appendChild(document.createElement("br",null))
z=W.dy("text")
z.id="size-input"
...
y.sbO(z,"# Colors")
a.appendChild(z)},
z2:function(a){var z=W.vD(a.querySelectorAll("input[type=\"text\"]"),null)
z.aN(z,new F.NG())
J.iA(a.style,"center")},
...
a.appendChild(document.createElement("br",null))
z=document.createElement("label",null)
z.textContent="Diagonals: "
J.Yt(z,"diagonal-check")
J.Lm(z.style,"100%")
a.appendChild(z)
z=W.dy("checkbox")
z.id="diagonal-check"
y=J.Vg(z)
H.VM(new W.Ov(0,y.uv,y.fA,W.aF(new F.l0()),y.el),[H.Kp(y,0)]).DN()
a.appendChild(z)
z=W.dy("text")
z.id="diagonal-input"
y=J.RE(z)
...
switch(J.Vm(J.n9(J.IT(document.querySelector("#graphtype-input"))))){case"grid":z=Z.Tj(document.querySelector("#canvas-area"),document.querySelector("#controls"),document.querySelector("#output-area"),9)
break
case"random":z=Z.GD(document.querySelector("#canvas-area"),document.querySelector("#controls"),document.querySelector("#output-area"),9)
break
default:z=Z.Tj(document.querySelector("#canvas-area"),document.querySelector("#controls"),document.querySelector("#output-area"),9)}y=z.zx
x=J.RE(y)
x.sP(y,J.WB(x.gP(y),"Starting new resample run.\nProbability distribution: "+H.d(z.zX.LV)))
z.bL()
return z},
O3:{
"^":"Tp:8;a",
$1:function(a){return F.Tf(this.a)}},
rs:{
"^":"Tp:8;",
$1:function(a){var z,y
z=$.bb
...
z.Hz=P.xC(0,0,0,y*10,0,0)}},
Gc:{
"^":"Tp:8;",
$1:function(a){var z=$.bb
z.GL=!z.GL
z.bL()
z=J.RE(a)
if(J.nJ(z.gN(a))==="Start")J.t3(z.gN(a),"Stop")
else J.t3(z.gN(a),"Start")}},
es:{
"^":"Tp:8;",
$1:function(a){H.Go(document.querySelector("#output-area"),"$isFB").value=""
$.bb.GL=!1
$.bb=F.S3()}},
NG:{
"^":"Tp:8;",
...
l0:{
"^":"Tp:8;",
$1:function(a){if(J.TY(document.querySelector("#diagonal-input").style)==="hidden")J.IR(document.querySelector("#diagonal-input").style,"visible")
else J.IR(document.querySelector("#diagonal-input").style,"hidden")}}},1],["","",,Z,{
"^":"",
Pr:{
"^":"a;tL'",
bL:[function(){var z,y
if(!this.GL)return
if(this.zX.iQ(0)===!0){z=this.zx
y=J.RE(z)
y.sP(z,J.WB(y.gP(z),"\nComplete!\nTotal resamples: "+this.zX.XI))
this.YW()
return}else{this.YW()
P.dT(this.Hz,this.gcP(),null)}},"$0","gcP",0,0,2],
rU:function(a){},
q5:function(a){},
nm:function(a){},
...
this.eo.lineWidth=this.WO/2
for(z=this.zX.kH,z=new H.a7(z,z.length,0,null);z.G();){w=z.lo
for(y=w.grf(),y=new H.a7(y,y.length,0,null);y.G();){v=y.lo
if(v.gbV()===w)this.nm(v)}}for(z=this.zX.kH,z=new H.a7(z,z.length,0,null);z.G();){w=z.lo
this.rU(w)
this.q5(w)}},
WM:function(a,b,c,d){var z=this.Fn
if(J.Vm(z.querySelector("#size-input"))!=="")this.tL=H.BU(J.Vm(z.querySelector("#size-input")),null,null)
this.eo=J.uP(this.qN)
z=J.W3(z.querySelector("#timer-value"))
if(typeof z!=="number")return z.U()
this.Hz=P.xC(0,0,0,z*10,0,0)}},
Hy:{
"^":"Tp:8;a",
$1:function(a){return this.a.bL()}},
t2:{
"^":"Pr;qN,eo,Fn,zx,WO,Hz,zX,GL,tL",
...
w.toString
w.arc(y*v*4+v,u-x*v*4-v,v,0,6.283185307179586,!1)
this.eo.fillStyle=z.gih(a)
z=this.eo
z.toString
z.fill("nonzero")
this.eo.closePath()},
q5:function(a){var z,y,x,w,v,u,t,s
z=J.RE(a)
y=z.gx(a)
x=z.gy(a)
z=this.eo
...
if(typeof x!=="number")return x.U()
z.toString
z.fillText(v,y*u*4+u-t/2,5+s-x*u*4-u)},
nm:function(a){var z,y,x,w,v,u,t,s,r
z=a.bV
y=z.x
x=a.mu
w=x.x
if(y>w||z.y>x.y)return
if(a.Ep){v=this.eo
v.strokeStyle="#FF0000"}else if(y!==w&&z.y!==x.y){v=this.eo
v.strokeStyle="#FFFFFF"}else return
v.lineWidth=4
v.beginPath()
v=this.eo
u=this.WO
...
v.moveTo(y*u*4+u,r-z*u*4-u)
z=this.eo
t=s.gfg(t)
x=x.y
if(typeof t!=="number")return t.W()
z.lineTo(w*u*4+u,t-x*u*4-u)
this.eo.stroke()
this.eo.closePath()},
BP:function(a,b,c,d){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=null
y=null
x=6
w=J.K0(b.querySelector("#torus-check"))
v=0
t=2*d
s=J.RE(a)
s.sR(a,J.xH(J.vX(J.vX(this.tL,4),d),t))
s.sfg(a,J.xH(J.vX(J.vX(this.tL,4),d),t))
if(J.Vm(b.querySelector("#p-input"))!=="")z=P.C1(J.Vm(b.querySelector("#p-input")),null)
if(J.Vm(b.querySelector("#dist-input"))!=="")y=H.BU(J.Vm(b.querySelector("#dist-input")),null,null)
if(J.Vm(b.querySelector("#colors-input"))!=="")x=H.BU(J.Vm(b.querySelector("#colors-input")),null,null)
if(J.Vm(b.querySelector("#diagonal-input"))!=="")v=P.C1(J.Vm(b.querySelector("#diagonal-input")),null)
try{t=this.tL
s=z
r=y
q=x
p=w
o=v
n=new D.MQ(p,o,null,t,0,q,null,C.pr,s,r,null,null,null)
n.XQ(t,q,s,r)
n.LL(p,q,s,r,o,t)
this.zX=n}catch(m){t=H.Ru(m)
u=t
t=c
s=J.RE(t)
s.sP(t,J.WB(s.gP(t),J.AG(u)))
throw H.b(u)}},
static:{Tj:function(a,b,c,d){var z,y
z=c
y=new Z.t2(a,null,b,z,d,null,null,!0,10)
y.WM(a,b,z,d)
y.BP(a,b,c,d)
return y}}},
tr:{
"^":"Pr;Zl,qN,eo,Fn,zx,WO,Hz,zX,GL,tL",
rU:function(a){var z,y,x,w,v,u
z=J.RE(a)
y=z.gx(a)
x=z.gy(a)
...
if(typeof x!=="number")return H.s(x)
w.toString
w.arc(v*y+v+u,v*x+v+u,u,0,6.283185307179586,!1)
this.eo.fillStyle=z.gih(a)
z=this.eo
z.toString
z.fill("nonzero")
...
if(typeof x!=="number")return x.U()
z.toString
z.fillText(v,y*u+u+t-s/2,5+x*u+u+t)},
nm:function(a){var z,y,x,w,v
z=a.Ep
y=this.eo
if(z)y.strokeStyle="#FF0000"
else y.strokeStyle="#FFFFFF"
y.lineWidth=4
y.beginPath()
z=this.eo
y=a.bV
...
w=this.Zl
v=this.WO
z.moveTo(x*w+w+v,y.y*w+w+v)
w=this.eo
y=a.mu
x=y.x
z=this.Zl
w.lineTo(x*z+z+v,y.y*z+z+v)
this.eo.stroke()
this.eo.closePath()},
Fj:function(a,b,c,d){var z,y,x,w,v,u,t,s,r,q,p
z=null
y=null
x=6
w=4
...
if(J.Vm(b.querySelector("#dist-input"))!=="")y=H.BU(J.Vm(b.querySelector("#dist-input")),null,null)
if(J.Vm(b.querySelector("#colors-input"))!=="")x=H.BU(J.Vm(b.querySelector("#colors-input")),null,null)
if(J.Vm(b.querySelector("#degree-input"))!=="")w=H.BU(J.Vm(b.querySelector("#degree-input")),null,null)
try{u=this.tL
t=z
s=y
r=x
q=new D.as(w,null,u,0,r,null,C.pr,t,s,null,null,null)
q.XQ(u,r,t,s)
q.od="Random"
this.zX=q}catch(p){u=H.Ru(p)
v=u
u=c
t=J.RE(u)
t.sP(u,J.WB(t.gP(u),J.AG(v)))
throw H.b(v)}},
static:{GD:function(a,b,c,d){var z,y
z=c
y=new Z.tr(null,a,null,b,z,d,null,null,!0,10)
y.WM(a,b,z,d)
y.Fj(a,b,c,d)
return y}}}}],])
...
init.metadata=[{func:"uO",args:[P.qU]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"Vs",ret:P.KN,args:[P.fR,P.fR]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"aB",args:[null]},{func:"NT"},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
